...
cfg_os_poll! {
    ...
    fn pair<T>(flags: libc::c_int) -> io::Result<(T, T)>
        where T: FromRawFd,
    {
        #[cfg(not(any(target_os = "ios", target_os = "macos", target_os = "solaris", target_os = "watchos")))]
        ...
        #[cfg(any(target_os = "ios", target_os = "macos", target_os = "solaris", target_os = "watchos"))]
        {
